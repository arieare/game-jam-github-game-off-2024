...
var wasd_asset = preload("res://collection/carchemy_survival/content/sprite/accessibility_key_wasd.png")
var arrow_asset = preload("res://collection/carchemy_survival/content/sprite/accessibility_key_arrow.png")
