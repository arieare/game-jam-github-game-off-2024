...
@onready var main_menu_node = preload("res://scene/menu.tscn")
var is_main_menu_instanced: bool = false
var main_menu_instance

@onready var gameplay_node = preload("res://scene/arcade.tscn")

@onready var gameover_node = preload("res://scene/game_over.tscn")
